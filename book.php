        ...
        <div class="row">
            ...
            <div class="col-md-6" style="width: 815px;height: 1300px;margin-left: 573px;margin-top: 73px;position: absolute">
                ...
                <form action="book_service.php" method="post">
                    ...
                    <div class="btn btn-primary" style="margin-left: 33px;width: 750px;height: 58px;border-radius: 0px;background: #1c1b1b;font-size: 20px;font-family: Montserrat, sans-serif;color: rgb(255, 255, 255);font-weight: bold;border-width: 1px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(255,255,255);border-left-color: rgb(255,255,255); padding-top: 11px;"><input type='hidden' value='no' name='d'><input type="checkbox" value="yes" id="d" name="d"> <label for="d"> DETAILING</label></div>
                    <div class="btn btn-primary" style="margin-left: 33px;width: 750px;height: 58px;border-radius: 0px;background: #1c1b1b;font-size: 20px;font-family: Montserrat, sans-serif;color: rgb(255, 255, 255);font-weight: bold;border-width: 1px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(255,255,255);border-left-color: rgb(255,255,255);margin-top: 27px; padding-top: 11px;"><input type='hidden' value='no' name='cc'><input type="checkbox" value="yes" id="cc" name="cc"> <label for="cc"> CERAMIC COATING</label></div>
                    <div class="btn btn-primary" style="margin-left: 33px;width: 750px;height: 58px;border-radius: 0px;background: #1c1b1b;font-size: 20px;font-family: Montserrat, sans-serif;color: rgb(255, 255, 255);font-weight: bold;border-width: 1px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(255,255,255);border-left-color: rgb(255,255,255);margin-top: 27px; padding-top: 11px;"><input type='hidden' value='no' name='pc'><input type="checkbox" value="yes" id="pc" name="pc"> <label for="pc"> PAINT CORRECTION</label></div>
                    <div class="btn btn-primary" style="margin-left: 33px;width: 750px;height: 58px;border-radius: 0px;background: #1c1b1b;font-size: 20px;font-family: Montserrat, sans-serif;color: rgb(255, 255, 255);font-weight: bold;border-width: 1px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(255,255,255);border-left-color: rgb(255,255,255);margin-top: 27px; padding-top: 11px;"><input type='hidden' value='no' name='wt'><input type="checkbox" value="yes" id="wt" name="wt"> <label for="wt"> WINDOW TINT</label></div>
                    <div class="btn btn-primary" style="margin-left: 33px;width: 750px;height: 58px;border-radius: 0px;background: #1c1b1b;font-size: 20px;font-family: Montserrat, sans-serif;color: rgb(255, 255, 255);font-weight: bold;border-width: 1px;border-top-color: rgb(255,255,255);border-right-color: rgb(255,255,255);border-bottom-color: rgb(255,255,255);border-left-color: rgb(255,255,255);margin-top: 27px; padding-top: 11px;"><input type='hidden' value='no' name='ppf'><input type="checkbox" value="yes" id="ppf" name="ppf"> <label for="ppf"> PAINT PROTECTION FILM</label></div>
